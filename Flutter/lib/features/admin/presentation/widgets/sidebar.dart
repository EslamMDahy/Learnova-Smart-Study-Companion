...
class _NavLink extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ background حسب الحالة (hover/pressed) + selected ثابت
    ...
    // ✅ foreground لون الأيقونة والنص حسب الحالة
      ...
      child: SizedBox(
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            // ✅ ده اللي بيحقق الشكل بتاع فيجما
            overlayColor: bg,
                  ...
                  SizedBox(
                    ...
                    child: Center(
                      child: IconTheme(
                        ...
                        child: Builder(
                          builder: (context) {
                            // ✅ نخلي الأيقونة تاخد color من states فعليًا
                            return Icon(
                              icon,
                              size: 22,
